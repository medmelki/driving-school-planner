            ...
            link: function (scope, el, attrs) {
                ...
                scope.options = {
                    ...
                    eventClick: function (event, jsEvent, view) {
                        ...
                        $('.modal-body:first').html('<strong>Contrat n° : </strong>' + event.card.contractId + '<br>');

                        $('.modal-body:first').append('<strong>Email : </strong>' +
                            (event.card.email ? event.card.email : '_') + '<br>');
                        $('.modal-body:first').append('<strong>Type : </strong>' +
                            (event.card.type ? event.card.type : '_') + '<br>');
                        $('.modal-body:first').append('<strong>Telephone : </strong>' +
